...
/*   Updated: 2025/06/09 17:12:55 by anastruc         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
std::cout << "CONSTRUCTION AVEC FD MARCHE PAS  = " << _fd << std::endl;
}
...
{
    // Tu peux aussi logguer ici pour debug !
    std::cout << "[WriteCallback] COPY CONSTRUCTOR called for fd=" << _fd << std::endl;
}
